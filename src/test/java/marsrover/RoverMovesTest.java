...
public class RoverMovesTest {
    ...
    void roverMovesForwardOnceTowardNorth() {
        Rover rover = aRover(mars(), coordinates(1, 2), Direction.NORTH);
        rover.execute('f');
    ...
    void roverMovesForwardOnceTowardEast() {
        Rover rover = aRover(mars(), coordinates(1, 2), Direction.EAST);
        rover.execute('f');
    ...
    void roverMovesForwardTowardSouth() {
        Rover rover = aRover(mars(), coordinates(1, 2), Direction.SOUTH);
        rover.execute('f');
    ...
    void roverMovesForwardTowardWest() {
        Rover rover = aRover(mars(), coordinates(2, 2), Direction.WEST);
        rover.execute('f');
    ...
    void roverFacingEastMovesBackward() {
        Rover rover = aRover(mars(), coordinates(2, 2), Direction.EAST);
        rover.execute('b');
        assertThat(rover.getPosition()).isEqualTo(coordinates(1, 2));
    }
    ...
    void roverFacingWestMovesBackward() {
        Rover rover = aRover(mars(), coordinates(1, 2), Direction.WEST);
        rover.execute('b');
        assertThat(rover.getPosition()).isEqualTo(coordinates(2, 2));
    }
    ...
    void roverMovesOutOfPlanetBoundsGoingToTheLeft() {
        Rover rover = aRover(mars(), coordinates(1, 1), Direction.WEST);
        rover.execute('f');
        assertThat(rover.getPosition()).isEqualTo(coordinates(20, 1));
    }

    @Test
    void roverMovesOutOfPlanetBoundsGoingToTheRight() {
        Rover rover = aRover(mars(), coordinates(20, 1), Direction.EAST);
        rover.execute('f');
        assertThat(rover.getPosition()).isEqualTo(coordinates(1, 1));
    }
    ...
    void roverMovesOutOfPlanetBoundsGoingUp() {
        Rover rover = aRover(mars(), coordinates(5, 20), Direction.NORTH);
        rover.execute('f');
        assertThat(rover.getPosition()).isEqualTo(coordinates(5, 1));
    }
